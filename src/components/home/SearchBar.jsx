  ...
  return (
    ...
    >
      ...
      <div className="flex-1 relative">
        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-[#F97316]-500">
        ...
        <select
          ...
          className="w-full pl-12 pr-4 py-3.5 bg-gray-50/80 border border-gray-200 rounded-xl text-gray-900 text-sm focus:outline-none focus:border-[#1256CC]-500 focus:ring-2 focus:ring-[#1256CC]-500/20 transition-all duration-200 shadow-sm appearance-none cursor-pointer"
        >
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.98 }}
        className="inline-flex items-center justify-center gap-2 px-8 py-3.5 md:px-10 bg-gradient-to-r from-[#F97316] -600 to- [#1256CC]-600 hover:from-[#F97316] -700 hover:to-purple-700 text-white font-semibold rounded-xl shadow-lg shadow-indigo-500/30 hover:shadow-xl transition-all duration-200 whitespace-nowrap"
      >

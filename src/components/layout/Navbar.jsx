    ...
    <nav className="bg-white/90 backdrop-blur-md border-b border-gray-200/60 shadow-sm sticky top-0 z-50 transition-all duration-200">
      <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-2.5 group">
          <div className="w-9 h-9 bg-gradient-to-br from-indigo-600 to-purple-600 rounded-2xl flex items-center justify-center shadow-md shadow-indigo-500/30 transform group-hover:scale-105 transition-all duration-200">
        ...
        <div className="hidden md:flex items-center gap-6">
          <Link to="/a-propos" className="text-gray-600 hover:text-indigo-600 font-medium transition-colors duration-200">
            À propos
          </Link>
          <Link to="/artisans" className="text-gray-600 hover:text-indigo-600 font-medium transition-colors duration-200">
            Trouver un artisan
          </Link>
          {!isArtisan && (
            <Link to="/inscription-artisan" className="text-gray-600 hover:text-indigo-600 font-medium transition-colors duration-200">
              Devenir prestataire
            </Link>
          )}
          <Link to="/contact" className="text-gray-600 hover:text-indigo-600 font-medium transition-colors duration-200">
            Contact
          </Link>
        </div>
        ...
        <div className="flex items-center gap-3">
          {user ? (
            ...
            <>
              <Link to="/connexion" className="inline-flex items-center justify-center px-4 py-2.5 rounded-full border border-gray-200 bg-white/80 text-sm font-medium text-gray-700 hover:border-indigo-300 hover:text-indigo-600 hover:bg-indigo-50/50 shadow-sm transition-all duration-200">
                Connexion
              </Link>
              <Link to="/inscription" className="hidden md:inline-flex items-center justify-center px-4 py-2.5 rounded-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white text-sm font-medium shadow-md shadow-indigo-500/30 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200">
                S'inscrire
              </Link>
            </>
          )}

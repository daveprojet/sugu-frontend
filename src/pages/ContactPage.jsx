    ...
    <main className="min-h-screen bg-gradient-to-br from-indigo-50/30 via-white to-purple-50/30 py-12 px-4">
      ...
      >
        ...
        <section className="relative overflow-hidden rounded-3xl mb-10 p-10 md:p-14 shadow-2xl shadow-gray-200/60">
          ...
          <div className="relative z-10 max-w-2xl">
            ...
            <p className="text-gray-500 text-base mt-3 max-w-lg leading-relaxed">
              Une question, un souci avec une demande ou envie de rejoindre la plateforme ? Écrivez-nous.
            </p>
          </div>
        </section>
        {/* ====================================== */}
        ...
        >
          ...
          <motion.section variants={itemVariants} className="bg-white/80 backdrop-blur-sm p-8 rounded-3xl border border-gray-100/80 shadow-2xl shadow-gray-200/60">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 rounded-xl bg-indigo-50 flex items-center justify-center text-indigo-600">
                <MessageSquare className="w-5 h-5" />
              </div>
              <h2 className="font-display text-lg font-semibold text-gray-900">Envoyer un message</h2>
            </div>
            ...
            <form onSubmit={handleSubmit} className="grid md:grid-cols-2 gap-5">
              ...
              <div className="md:col-span-2">
                <label className="block text-sm font-medium text-gray-700 mb-2 ml-1">Sujet</label>
                <input
                  value={form.sujet}
          ...
          <aside className="flex flex-col gap-6">
            <motion.section variants={itemVariants} className="bg-white/80 backdrop-blur-sm p-6 rounded-3xl border border-gray-100/80 shadow-2xl shadow-gray-200/60">
              <h2 className="font-display text-lg font-semibold text-gray-900 mb-4">Coordonnées</h2>
              <div className="flex flex-col gap-4 text-sm">
                <a href={`mailto:${contactEmail}`} className="flex items-center gap-3 text-gray-700 hover:text-indigo-600 transition-colors group">
                ...
                <a href={`tel:${contactPhone}`} className="flex items-center gap-3 text-gray-700 hover:text-indigo-600 transition-colors group">
                  <div className="w-9 h-9 rounded-lg bg-indigo-50 text-indigo-600 flex items-center justify-center group-hover:bg-indigo-100 transition-colors">
            ...
            <motion.section variants={itemVariants} className="bg-gradient-to-br from-indigo-50/70 to-purple-50/70 backdrop-blur-sm p-6 rounded-3xl border border-indigo-200/40 shadow-2xl shadow-gray-200/60">
              <h2 className="font-display text-lg font-semibold text-gray-900 mb-3">Besoin rapide ?</h2>
              <p className="text-sm text-gray-600 leading-relaxed mb-4">
                Pour trouver un prestataire, consultez directement la liste des artisans disponibles.
              </p>
              <a href="/artisans" className="inline-flex items-center justify-center gap-2 w-full py-3 px-4 border border-gray-200 bg-white/60 rounded-xl text-sm font-medium text-indigo-600 hover:bg-indigo-50 hover:border-indigo-200 transition-colors shadow-sm hover:shadow-md group">
                Voir les artisans

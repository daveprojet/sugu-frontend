...
// 1. IMPORT DE L'IMAGE LOCALE (Assure-toi que le chemin est correct)
import heroBg from '/images/metiers/hero-bg.jpg'

export default function HomePage() {
  // Animations pour la section Comment ça marche
  const fadeUpVariant = {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-indigo-600 via-purple-600 to-indigo-800 text-white overflow-hidden min-h-[600px] flex items-center">
        ...
        <div className="absolute inset-0 -z-10">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-indigo-900/90 via-indigo-600/80 to-purple-600/80 mix-blend-multiply" />
        </div>
        {/* ========================= */}

        {/* Motif de fond (points) */}
        <div className="absolute inset-0 opacity-20" style={{ backgroundImage: 'radial-gradient(circle at 20% 50%, #ffffff 1px, transparent 1px)', backgroundSize: '30px 30px' }} />
        ...
        <div className="relative z-10 max-w-4xl mx-auto py-24 px-4 text-center">
          ...
          >
            ...
            <span className="text-purple-200 drop-shadow-md">près de chez vous</span>
          </motion.h1>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16 md:py-20">
        <div className="text-center md:text-left mb-12">
          ...
          <p className="text-gray-500 text-lg">Sélectionnez le type d'artisan dont vous avez besoin</p>
        </div>
        <MetierGrid />
      </section>
      ...
      <section className="bg-gradient-to-br from-gray-50/50 to-indigo-50/30 py-16 md:py-20 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          >
            {[
              { step: '1', icon: Search, title: 'Cherchez', desc: 'Entrez votre besoin et votre quartier' },
              { step: '2', icon: User, title: 'Choisissez', desc: 'Consultez les profils et avis clients' },
              { step: '3', icon: Phone, title: 'Contactez', desc: 'Appelez ou envoyez un message WhatsApp' },
